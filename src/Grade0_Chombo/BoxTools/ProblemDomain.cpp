...
ProblemDomain::intersects(const Box& a_box) const
{
  ...
  return (D_TERM6((m_isPeriodic[0]
                   || (a_box.smallEnd(0)>m_domainBox.smallEnd(0)
                       || a_box.bigEnd(0)<m_domainBox.bigEnd(0))), ||
                  (m_isPeriodic[1]
                   || (a_box.smallEnd(1)>m_domainBox.smallEnd(1)
                       || a_box.bigEnd(1)<m_domainBox.bigEnd(1))), ||
                  (m_isPeriodic[2]
                   || (a_box.smallEnd(2)>m_domainBox.smallEnd(2)
                       || a_box.bigEnd(2)<m_domainBox.bigEnd(2))), ||
                  (m_isPeriodic[3]
                   || (a_box.smallEnd(3)>m_domainBox.smallEnd(3)
                       || a_box.bigEnd(3)<m_domainBox.bigEnd(3))), ||
                  (m_isPeriodic[4]
                   || (a_box.smallEnd(4)>m_domainBox.smallEnd(4)
                       || a_box.bigEnd(4)<m_domainBox.bigEnd(4))), ||
                  (m_isPeriodic[5]
                   || (a_box.smallEnd(5)>m_domainBox.smallEnd(5)
                       || a_box.bigEnd(5)<m_domainBox.bigEnd(5)))));
}
...
#ifdef CH_USE_PYTHON
ProblemDomain::ProblemDomain(PyObject* a_pin):
ProblemDomain(Box(PyTuple_GetItem(a_pin,0))){

  IntVect per(PyTuple_GetItem(a_pin,1));

  D_DECL6(m_isPeriodic[0]=(bool)per[0],
          m_isPeriodic[1]=(bool)per[1],
          m_isPeriodic[2]=(bool)per[2],
          m_isPeriodic[3]=(bool)per[3],
          m_isPeriodic[4]=(bool)per[4],
          m_isPeriodic[5]=(bool)per[5]
  );
}
PyObject* ProblemDomain::pack() const{
  PyObject *pArg = PyTuple_New(2+1);
  PyTuple_SetItem(pArg, 0, this->domainBox().pack());
  IntVect per(D_DECL6((int)m_isPeriodic[0],
                      (int)m_isPeriodic[1],
                      (int)m_isPeriodic[2],
                      (int)m_isPeriodic[3],
                      (int)m_isPeriodic[4],
  ...
  PyTuple_SetItem(pArg, 1, per.pack());
  std::string Label = "ProblemDomain";
